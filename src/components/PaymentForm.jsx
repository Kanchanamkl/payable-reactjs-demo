...
const PaymentForm = () => {
  ...
  const merchantToken = '7F1C2868D8AAFCAF2F0D06F38EFF54F2'; // Placeholder - DO NOT USE IN PRODUCTION CLIENT-SIDE
  ...
  const handleOneTimePayment = () => {
    ...
    const payment = {
      ...
      customerFirstName,
      customerLastName,
      customerMobilePhone: customerMobilePhone?.startsWith('+') ? customerMobilePhone : `+94${customerMobilePhone?.replace(/^0/, '')}`,
      customerPhone: '',
      customerEmail,
      customerRefNo,
      billingCompanyName: '',
